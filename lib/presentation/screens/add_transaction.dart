...
// import 'package:money_manager_app/provider/note.dart';
// import 'package:money_manager_app/provider/transaction.dart';
// import 'package:money_manager_app/util/color.dart';
...
//   void initState() {
//     super.initState();
//     // Reset providers when screen is initialized
//     super.initState();
...
//                                 null; // Reset category on tab change
//                           },
//                           child: Container(
...
//                 crossAxisSpacing: 10,
//                 mainAxisSpacing: 10,
//                 childAspectRatio: 0.8, // Adjust aspect ratio for better spacing
//               ),
...
//                 //     text: note,
//                 //   ), // Use controller to display note
//                 //   onChanged: (value) {
//                 //     ref.read(transactionNoteProvider.notifier).state = value;
//                 //   },
//                 //   decoration: InputDecoration(
//                 //     labelText:
//                 //         'Note: ${DateFormat('MMM dd').format(transactionDate)}', // Display date in label
//                 //     suffixIcon: IconButton(
//                 //       // Made camera icon a button
//                 //       icon: const Icon(Icons.camera_alt, color: Colors.grey),
//                 //       onPressed: () {
//                 //         // Handle camera action - placeholder
//                 //         ScaffoldMessenger.of(context).showSnackBar(
//                 //           const SnackBar(content: Text('Camera functionality')),
//                 //         );
//                 //       },
...
//           // Handle the '0' button to span two columns if needed (though current GridView doesn't support direct spanning)
//           // For now, it will just be a single button.
//           if (buttonText == '0' && index == buttons.length - 1) {
//             // This '0' button is the last one, it should ideally span 2 columns
//             // For GridView.builder with fixed cross axis count, direct spanning is complex.
//             // A simpler approach for the last row is to use a Row with Expanded widgets.
//             // For now, it will just be a single button.
//           }
      ...
      body: SingleChildScrollView( // <--- Wrap the Column with SingleChildScrollView
        child: Column(
          children: [
            ...
            // Category Grid
            SizedBox( // <--- Wrap GridView.builder with SizedBox and provide a height constraint
              height: MediaQuery.of(context).size.height * 0.35, // Adjust this value as needed
              child: GridView.builder(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: 4, // 4 items per row
